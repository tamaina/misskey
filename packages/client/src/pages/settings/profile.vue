...
<div class="_formRoot">
	...
	<FormSwitch v-model="showTimelineReplies" class="_formBlock">{{ $ts.flagShowTimelineReplies }}<template #caption>{{ $ts.flagShowTimelineRepliesDescription }}</template></FormSwitch>
