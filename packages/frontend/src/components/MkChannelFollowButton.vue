...
>
	<template v-if="!wait">
		<template v-if="isFollowing">
			<span v-if="full" :class="$style.text">{{ $locale.env.unfollow }}</span><i class="ti ti-minus"></i>
		</template>
		<template v-else>
	...
	<template v-else>
		<span v-if="full" :class="$style.text">{{ $locale.env.processing }}</span><MkLoading :em="true"/>
	</template>
</button>
</template>
